...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/profile/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/profile/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/profile/css/owl.theme.default.min.css">

    <!-- MAIN CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/profile/css/tooplate-ben-resume-style.css">
    <!--
...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
            ...
            <div class="row">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center col-lg-7 col-md-7 col-12">
                    <div class="hero-text">
                        ...
                        <h1 class="hero-title">👋 Rizal Purnomo</h1>
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel owl-theme" id="testimonials-carousel">
                        <div class="item">
                            <div class="testimonials-thumb d-flex">
                                <div class="testimonials-image">
                                    <img src="<?php echo base_url() ?>assets/profile/images/testimonials/testimonial-image01.jpg" class="img-fluid" alt="testimonials image">
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonials-thumb d-flex">
                                <div class="testimonials-image">
                                    <img src="<?php echo base_url() ?>assets/profile/images/testimonials/testimonial-image02.jpg" class="img-fluid" alt="testimonials image">
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonials-thumb d-flex">
                                <div class="testimonials-image">
                                    <img src="<?php echo base_url() ?>assets/profile/images/testimonials/testimonial-image03.jpg" class="img-fluid" alt="testimonials image">
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonials-thumb d-flex">
                                <div class="testimonials-image">
                                    <img src="<?php echo base_url() ?>assets/profile/images/testimonials/testimonial-image04.jpg" class="img-fluid" alt="testimonials image">
                                </div>
    ...
    <script src="<?php echo base_url() ?>assets/profile/js/smoothscroll.js"></script>
    <script src="<?php echo base_url() ?>assets/profile/js/owl.carousel.min.js"></script>
